...
public class BossHealth : MonoBehaviour
{
    ...
    public float CurrentHealth { get { return currentHealth; } } // Expose currentHealth via property
    ...
    private IEnumerator DestroyAfterAnimation()
    {
        ...
        while (!stateInfo.IsName("death")) // Replace with your death animation state name
        {
            yield return null;
